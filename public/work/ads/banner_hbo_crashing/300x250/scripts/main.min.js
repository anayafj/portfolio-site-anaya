...
var $ad, $bgExits, $videoContainer, $mainVideo, $videoExit, $cfs, $vidControls, $replayBtn,
    $expBackground, $expLogo, $expPedigree, $expDate, $expHeader;
...
AD.addVideos = function() {
    ...
    BLT.Video.addVideo (pathAka+'hbo_crashing_300x250_user_sundays', 'default', '30sec');

    // Post
    BLT.Video.addVideo (pathAka+'hbo_crashing_300x250_intro', 'post', 'intro');
    BLT.Video.addVideo (pathAka+'hbo_crashing_300x250_user_tonight', 'post', '30sec');
};
...
AD.expandAnimation = function() {
    ...
    tlExpand.from($expBackground,1,{opacity:0}, "start");
    tlExpand.from($expLogo,0.4,{opacity: 0,}, "lockup");
    tlExpand.from($expPedigree,1,{opacity:0}, "lockup");
    tlExpand.from($expDate,1,{opacity:0}, "lockup");
    tlExpand.from($expHeader,1,{opacity:0}, "lockup+=1");
};
...
AD.checkDate = function () {
    ...
    BLT.Tunein.addDate (2017, 3, 5, 'post');
